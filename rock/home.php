...
<body class="main-layout">
    ...
    <section class="banner_section">
        <div class="banner-main">
            ...
            <div class="container">
                ...
                <h1>Music Shop<br><span class="Perfect">The Perfect Music Shop</span><br>Welcome To The Music</h1>
                    ...
                    <a href="album.php">Buy albums now</a>
                </div>
    ...
    <!--  footer -->
    <footer id="footer_with_contact" id="login">
        <div class="footer">
            <div class="container">
                <div class="row">
