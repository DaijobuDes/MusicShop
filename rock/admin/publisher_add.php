            ...
            <div class=" col-md-6 offset-md-3">
                <div class="address">
                    ...
                    <form method="POST" action="publisher_add.php">
                        <div class="row">
                            <div class="col-sm-12">
                                <input class="contactus" placeholder="Publisher Name" type="text" name="publisher">
                            </div>
                            <div class="col-sm-12">
                                <input class="contactus" placeholder="Place Of Origin" type="text" name="place">
                            </div>
                            <div class="col-sm-12">
                                <input class="contactus" placeholder="Albums Published" type="number" name="albums">
                            </div>
                            <div class="col-sm-12">
                                <input class="contactus" placeholder="Rating" type="number" name="rating">
                            </div>
                            <div class="col-sm-12">
